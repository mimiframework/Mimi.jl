...
#
# Abstract type hierarchy (formerly auto-generated by Classes.jl @class macro)
#

# Definition types
abstract type AbstractNamedObj end
abstract type AbstractDatumDef <: AbstractNamedObj end
abstract type AbstractVariableDef <: AbstractDatumDef end
abstract type AbstractParameterDef <: AbstractDatumDef end
abstract type AbstractComponentDef <: AbstractNamedObj end
abstract type AbstractCompositeComponentDef <: AbstractComponentDef end

# Reference types
abstract type AbstractComponentReference end

# Instance types
abstract type AbstractComponentInstanceData end
abstract type AbstractComponentInstance end
abstract type AbstractCompositeComponentInstance <: AbstractComponentInstance end
