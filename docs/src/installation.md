...
The best way to get started with Mimi is to work through the **Tutorials**. The `examples/tutorial` folder in the [Mimi](https://github.com/anthofflab/Mimi.jl) github repository has julia code files that completely implement the example described in the tutorial.
