...
a_sym = Mimi.get_external_param_name(m.mi.md, :MyComp, :a)
b_sym = Mimi.get_external_param_name(m.mi.md, :MyComp, :b)
g_sym = Mimi.get_external_param_name(m.mi.md, :MyComp, :g)
h_sym = Mimi.get_external_param_name(m.mi.md, :MyComp, :h)
