@testitem "ConnectorComp" begin
    ...
    update_param!(model3, :Short_multi, :a, [1,2])
    ...
    update_param!(model4, :Short_multi, :a, [1,2])
    ...
    update_param!(model6, :Long, :par, years)
