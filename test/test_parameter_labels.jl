...
set_external_parameter(model1, :wronglength, ones(3,3))
@test_throws ErrorException connectparameter(model1, :compA, :x, :wronglength)
...
@test_throws ErrorException set_external_parameter(model3, :x, x, [:time, :regions], duration=1)
