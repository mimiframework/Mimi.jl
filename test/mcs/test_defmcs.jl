...
# Same as LHS sim at top, but SobolData

# pull in data from SALib.jl Sobol runs 
samples_data = load("mcs/test_samples.csv") |> DataFrame
...
sim3 = @defsim begin
    ...
    sampling(SobolData, N = N, calc_second_order = false, samples = convert(Matrix, samples_data))
