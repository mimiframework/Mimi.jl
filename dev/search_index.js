...

{
    ...
    "category": "function",
    "text": "generate_trials!(sim::Simulation{T}, samples::Int; filename::Union{String, Nothing}=nothing)\n\nGenerate trials for the given Simulation instance using the defined `samplesize. Call this before running the sim to pre-generate data to be used by all scenarios.  Also saves inputs if a filename is given.\n\n\n\n\n\n"
},
